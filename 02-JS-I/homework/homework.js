...
function obtenerSaludo(nombre) {
  ...
  var saludo = 'Hola '
  var exclamacio = '!'
  var obtenerSaludo = saludo + nombre + exclamacio;
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if (letra.length>1){
    var msnvocal = 'Dato incorrecto' ;
    return  msnvocal  
  }
  var esVocal = (/^[aeiou]/i).test(letra);
  if (esVocal==true){
    var msnvocal = 'Es vocal' ;
    return  msnvocal
  }
  var msnvocal = 'Dato incorrecto' ;
  return  msnvocal
